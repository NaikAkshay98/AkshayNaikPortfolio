...
import user_gif from '../assets/user-video2.gif'; // GIF version
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20 pt-5">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-5">
                <div className="max-w-max mx-auto relative">
                    ...
                    <img
                        src={isGifPlaying ? user_gif : user_image}
                        alt="User"
                        className="w-64 sm:w-80 rounded-3xl max-w-none cursor-pointer"
                        onClick={toggleImage}
                    />
